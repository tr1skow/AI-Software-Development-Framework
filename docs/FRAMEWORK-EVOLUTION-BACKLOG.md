...
| **Notes** | [ADR-004](./adr/ADR-004-AGENT-INTERACTION-MODEL.md); [Invocation Guide §9](./FRAMEWORK-INVOCATION-GUIDE.md); [M2 Declaration](./governance/RUNTIME-FOUNDATION-M2-DECLARATION.md) (Agent Collaboration packaging); README 1.0 Agent Pack positioning. **RI-001 evidence note recorded 2026-08-02 from repository inspection of tip [`37a201ce13242069f5355eb269fd92a59c7ec8b3`](https://github.com/tr1skow/Fitness-challenge-platform/tree/37a201ce13242069f5355eb269fd92a59c7ec8b3) (Framework baseline v0.2.1). This Notes field is the durable record; no separate assessment artefact exists.** Strongest tip-pinned RI sources: [Local Project Entry](https://github.com/tr1skow/Fitness-challenge-platform/blob/37a201ce13242069f5355eb269fd92a59c7ec8b3/docs/LOCAL-PROJECT-ENTRY.md); [Framework agent instructions](https://github.com/tr1skow/Fitness-challenge-platform/blob/37a201ce13242069f5355eb269fd92a59c7ec8b3/docs/FRAMEWORK-AGENT-INSTRUCTIONS.md); [observations.md](https://github.com/tr1skow/Fitness-challenge-platform/blob/37a201ce13242069f5355eb269fd92a59c7ec8b3/docs/reference-implementation/observations.md) **OBS-001**, **OBS-007** (also Policy, VALIDATION-021). Steward synthesis from that inspection (not formal VALIDATION-021 / observation conclusions for every topic): Normative coverage of authority, repository-first discovery, Stop, and Human Authority remains **adequate** (ADR-003/004, FA-005, Invocation, Method Spine); practical day-to-day AI-assistant packaging remains **incomplete**. **Candidate Informative packaging topics suggested by Framework absences and RI-001 practice** (not Norms; not FEA-ready): thin configurable agent-instruction template; tool-neutral recommended role patterns; persistent-vs-task context guidance; write-boundary guidance; short repository-first prompt guidance; anti-pattern teaching; linked RI examples. RI-001 examples remain **Informative evidence only** and must **not** become Framework Norms. Related Candidates: item 5 (future Getting Started should consume this packaging); item 15 / [Issue #9](https://github.com/tr1skow/AI-Software-Development-Framework/issues/9) (repository-authority bootstrap); item 14 / [Issue #8](https://github.com/tr1skow/AI-Software-Development-Framework/issues/8) (interactive Human Decision Gate). **Maturity Trigger not yet met** on current single-RI evidence. Status remains **Candidate**. Not Ready for Investigation; not FEA; no Normative change. |
...
| **Notes** | RI-001 source evidence lives in `tr1skow/Fitness-challenge-platform`: `docs/reference-implementation/observations.md` OBS-038 and `docs/reference-implementation/beta-candidates.md` BETA-CAND-002. The RI explicitly classifies OBS-038 as Implementation-only and BETA-CAND-002 as aggregation only; this backlog item preserves the uncertainty upstream without reclassifying the RI evidence as a Framework defect. No GitHub Issue is created at intake. Issue tracking may be added later only if active investigation or a separate durable tracking need is justified. |
...
| 2026-07-31 | Item 13 acceptance completed: GD-001 → Accepted (FEA-001; origin evidence clarified; bootstrap note historical only). Does not modify architecture, Runtime, or any Reference Implementation repository. |
...
| 2026-08-02 | Item 6 Notes updated with an RI-001 evidence note recorded 2026-08-02 from repository inspection of tip `37a201ce13242069f5355eb269fd92a59c7ec8b3` (this Notes field is the durable record; no separate assessment artefact exists). Item 5 Notes updated so a future Getting Started experience links to / consumes item 6 packaging. Status remains Candidate; Maturity Trigger unmet. No FEA; no Design Investigation; not Normative |
