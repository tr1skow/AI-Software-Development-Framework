...
Current maturity is **Framework v0.2.1** with **Runtime Foundation M2**
...
| **Framework v0.2.1** | Official **development baseline** for evolution and the first official reference implementation |
...
Framework v0.2.1 / Runtime Foundation M2 does **not** mean:
...
**Where.** Non-claims in the M2 Declaration; Framework v0.2.1 as development
...
| -------- | ------------ |
| **Framework v0.2.1** (current official development baseline) | Runtime Foundation M2; GD-001 Accepted; suitable to evolve the Framework and run the first official reference implementation under honest constraints |
...
**What.** At Framework v0.2.1 / Runtime Foundation M2, honest claims include
...
Saying what Framework v0.2.1 and Runtime Foundation M2 do — and do not —
