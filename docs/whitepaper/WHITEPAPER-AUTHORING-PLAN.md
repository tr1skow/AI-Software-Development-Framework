...
| | |
|--|--|
| **Objective** | Identify Framework version (v0.2.1), Informative/Reference force, non-law banner, authority-conflict statement |
...
Do not treat checkpoints as Framework releases. Whitepaper version tracks **Framework v0.2.1** until a later release bumps both.
