...
| Related | [ADR-001](./ADR-001-FRAMEWORK-CORE-SEMANTICS.md); Method Spine (frozen); Stage 1A Framework Architecture (frozen); Stage 1A.1 Architecture Refinement (frozen); Stage 1B ADR Roadmap (frozen) |
